...
<template>
        <form action="http://localhost:5000/api/upload" method="post" enctype="multipart/form-data">
                ...
                <label for="upload">
                        <div class="grid place-items-center hover:bg-secondary-700 rounded-lg cursor-pointer mt-8 pt-2 pb-4">
                                <svg class="fill-gray-900" width="60px" height="60px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="font-bold text-accent-700">Upload your resume</span>
        <p>
        {{ filenames }}
        </p>
</template>
        ...
        export default {
                ...
                methods: {
                        async send_upload() {
                                ...
                                fd.append("file-upload", this.image);
